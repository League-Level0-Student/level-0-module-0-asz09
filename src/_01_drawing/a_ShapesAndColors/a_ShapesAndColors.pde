...
//    The ellipse command looks like this:      
 ellipse(400,555,311,311);
 ellipse(400,311,211,211);
 ellipse(400,176,121,121);
 
 
 fill(#1F1F1F);
 ellipse(400,311,20,20);
 ellipse(400,356,20,20);
 ellipse(400,269,20,20);
 ellipse(420,176,10,10);
ellipse(380,176,10,10); 
rect(330,110,140,20);
rect(350,50,96,80);
...
//    Color is added with the fill command that looks like this:       fill(black);
